$.fn.navFixed=function(){
    ...
    _topPosition=$(document).scrollTop();_navPosition=$_this.prev().outerHeight(true);a();$(document).scroll(function(){
        _topPosition=$(document).scrollTop();a()});
    $(window).resize(function(){_navPosition=$_this.prev().outerHeight(true);a()});
    function a(){
